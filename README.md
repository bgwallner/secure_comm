...
1) Attacker could otherwise use this public key, generate a random number , encrypt with public key, and return to sender -> Sender think it is using Receivers symmetric key for encryption, MAC etc.
2) Attacker could otherwise tamper content which would render it useless -> Key exchange would fail
